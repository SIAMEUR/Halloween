...
var interval = setInterval(createPumpkin, 1000);

/**
 * A function to create and insert a pumpkin
 **/
function createPumpkin(){
	...
	if (document.getElementsByClassName("pumpkin").length == 10){
		...
		// The HTML code of a pumpkin (positioned at 300, 200)
		// <div class="pumpkin" style="left:300px; top: 200px;">
		// 	<div class="left-pumpkin"></div>
		// 	<div class="right-pumpkin"></div>
		// 	<div class="middle-pumpkin"></div>
		// 	<div class="mouth"></div>
		// 	<div class="lip"></div>
...
/**
 * A function to pick a random position inside the body element
 * @return {array} An array of two integers, one for each coordinate
 **/
...
/**
 * A function to explode a pumpkin
 * @param pumpkin - the pumpkin to explode
 **/
